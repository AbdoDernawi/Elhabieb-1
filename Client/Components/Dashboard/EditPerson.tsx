...
export default function EditPerson({ type }: { type: string }) {
  const [formData, setFormData] = useState({
    name: "mohamed ali",
    email: "hefnawye@gmail.com",
    position: "",
    department: "",
    password: "121212",
  });
  ...
  const [selectedVariant, setSelectedVariant] = React.useState("موظف");
  ...
  const Body = () => {
    return (
      <div
        className="container mx-auto p-6 bg-white rounded-lg shadow-md mt-1"
        dir="rtl"
      >
